...
//                             <label>Name</label>
//                             <FormInput placeholder="Name" value={this.state.nameQuery}
//                                        onChange={this.handleNameQueryChange}/>
//                         </FormGroup></Col>
//                         <Col flex={2}><FormGroup style={{width: '20vw', margin: '0 auto'}}>
//                             <label>Nationality</label>
//                             <FormInput placeholder="Nationality" value={this.state.nationalityQuery}
...
//                         <Col flex={2}><FormGroup style={{width: '20vw', margin: '0 auto'}}>
//                             <label>Club</label>
//                             <FormInput placeholder="Club" value={this.state.clubQuery}
...
//                                     <img src={this.state.selectedPlayerDetails.Photo} referrerpolicy="no-referrer"
//                                          alt={null} style={{height: '15vh'}}/>
//
//                                 </Col>
//                             </Row>
...
//                                     <img src={this.state.selectedPlayerDetails.Flag} referrerpolicy="no-referrer"
//                                          alt={null} style={{height: '3vh', marginLeft: '1vw'}}/>
//                                 </Col>
//
//                             </Row>
//                             <Row gutter='30' align='middle' justify='left'>
...
//                                               value={this.state.selectedPlayerDetails.BestOverallRating}>{this.state.selectedPlayerDetails.BestOverallRating}</Progress>
...
//                                     <h6>Potential</h6>
//                                     <Progress style={{width: '20vw'}}
//                                               value={this.state.selectedPlayerDetails.Potential}>{this.state.selectedPlayerDetails.Potential}</Progress>
//                                     <h6>Rating</h6>
//                                     <Progress style={{width: '20vw'}}
//                                               value={this.state.selectedPlayerDetails.Rating}>{this.state.selectedPlayerDetails.Rating}</Progress>
//                                 </Col>
//                                 <Col push={2} flex={2}>
